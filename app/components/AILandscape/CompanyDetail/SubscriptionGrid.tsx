      ...
      {subscriptions.map(subscription => {
        ...
        return (
          <div 
            ...
            className={`bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow flex flex-col w-full sm:w-[calc(50%-8px)] md:w-[calc(33.33%-11px)] lg:w-[calc(25%-12px)] ${
