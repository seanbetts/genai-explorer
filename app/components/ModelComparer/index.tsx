        ...
        <div className="flex flex-col md:flex-row gap-3 mb-4">
          ...
          <div>
            ...
            <select 
              id="company-filter"
              className={brandConfig.name === 'OMG'
                ? 'w-full sm:w-auto bg-white border border-gray-300 rounded px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-600 appearance-none'
                : 'w-full sm:w-auto bg-gray-700 border border-gray-600 rounded px-3 py-2 text-gray-200 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 appearance-none'}
              style={{
                backgroundImage: brandConfig.name === 'OMG' 
                  ...
                  : 'url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 20 20\'%3E%3Cpath stroke=\'%299ca3af\' stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'1.5\' d=\'M6 8l4 4 4-4\'/%3E%3C/svg%3E")',
